...
SECRET_KEY = 'django-insecure-749%s($7@5$fra%dnbl5fw^psu+dda#1yp9sk(%bfg1kn4#veo'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ["rosolympiad.ru", "www.rosolympiad.ru", "127.0.0.1"]
...
AUTH_USER_MODEL = 'olympiads.User'
